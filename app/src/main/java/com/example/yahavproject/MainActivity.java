...
/*        if (phoneUser.equals("true")) {
    ...
    public class HandlerAlertDialogListener implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            if (i == -1) {
                clearEveryDaysMain("Sunday");
                clearEveryDaysMain("Monday");
                clearEveryDaysMain("Tuesday");
                clearEveryDaysMain("Wednesday");
                clearEveryDaysMain("Thursday");
                clearEveryDaysMain("Friday");
                clearEveryDaysMain("Saturday");
    ...
    public void clearEveryDaysMain(String day) {
